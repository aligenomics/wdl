...
* [ 语言规范](#language-specification)
  * [全局语法规则](#global-grammar-rules)
    * [空白, 字符, 变量名称, 固定常量](#whitespace-strings-identifiers-constants)
    * [变量类型](#types)
    * [完全限定名称 & 命名空间标识符](#fully-qualified-names--namespaced-identifiers)
    * [变量声明](#declarations)
    * [表达式](#expressions)
    * [运算符优先级排序](#operator-precedence-table)
    * [成员访问](#member-access)
    * [字典和数组索引](#map-and-array-indexing)
    * [Pair索引](#pair-indexing)
    * [函数调用](#function-calls)
    * [数组字面值](#array-literals)
    * [字典字典值](#map-literals)
    * [对象字面值](#object-literals)
    * [Pair字面值](#pair-literals)
  * [Document](#document)
